...
class GripperExample(Node):
    ...
    rclpy.logging.set_logger_level('gripper_example', LoggingSeverity.DEBUG)
...
def main(args=None):
    ...
    gripper_example= GripperExample()
    rclpy.spin(gripper_example)
    gripper_example.destroy_node()
    rclpy.shutdown()
