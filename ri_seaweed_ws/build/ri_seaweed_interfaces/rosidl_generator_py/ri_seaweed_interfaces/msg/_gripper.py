...
class Metaclass_Gripper(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ri_seaweed_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ri_seaweed_interfaces.msg.Gripper')
            logger.debug(
...
class Gripper(metaclass=Metaclass_Gripper):
    ...
    def __init__(self, **kwargs):
        ...
        self.close_request = kwargs.get('close_request', bool())
    ...
    def __eq__(self, other):
        ...
        if self.gripper_state != other.gripper_state:
            return False
        if self.close_request != other.close_request:
            return False
        return True
    ...
    def close_request(self):
        """Message field 'close_request'."""
        return self._close_request

    @close_request.setter
    def close_request(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'close_request' field must be of type 'bool'"
        self._close_request = value
