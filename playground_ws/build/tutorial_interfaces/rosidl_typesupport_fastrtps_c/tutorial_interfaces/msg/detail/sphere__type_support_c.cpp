...
#include "geometry_msgs/msg/detail/point__functions.h"  // cener
  ...
  tutorial_interfaces__msg__Sphere * ros_message)
{
  // Field name: cener
  {
    cdr_deserialize_geometry_msgs__msg__Point(cdr, &ros_message->cener);
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->cener), current_alignment);
