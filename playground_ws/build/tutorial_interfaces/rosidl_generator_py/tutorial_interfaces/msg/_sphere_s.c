...
bool tutorial_interfaces__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // cener
    PyObject * field = PyObject_GetAttrString(_pymsg, "cener");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->cener)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * tutorial_interfaces__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {  // cener
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->cener);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "cener", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
