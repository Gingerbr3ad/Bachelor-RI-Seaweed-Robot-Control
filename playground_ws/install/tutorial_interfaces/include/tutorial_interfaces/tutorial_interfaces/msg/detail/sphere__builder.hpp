...
class Init_Sphere_cener
{
public:
  Init_Sphere_cener()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Sphere_radius cener(::tutorial_interfaces::msg::Sphere::_cener_type arg)
  {
    msg_.cener = std::move(arg);
...
{
  return tutorial_interfaces::msg::builder::Init_Sphere_cener();
}
